...
public class LegendaryTreasureOmegaConfig extends Config {
    ...
    protected void reset() {
        ITEMS.add(new LegendaryItem("minecraft:enchanted_golden_apple", "{display:{Name:'{\"text\":\"Fanciest Apple\"}'}}"));
        ITEMS.add(new LegendaryItem("minecraft:diamond_sword", "{Enchantments:[{id:\"minecraft:sharpness\",lvl:10s}]}"));
    }
