...
public class LegendaryTreasureEpicConfig extends Config {
    ...
    protected void reset() {
        ITEMS.add(new ItemEntry("minecraft:golden_apple", "{display:{Name:'{\"text\":\"Fancier Apple\"}'}}"));
        ITEMS.add(new ItemEntry("minecraft:iron_sword", "{Enchantments:[{id:\"minecraft:sharpness\",lvl:10s}]}"));
    }
