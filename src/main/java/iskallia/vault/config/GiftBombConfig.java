...
public class GiftBombConfig extends Config {
    ...
    protected void reset() {
        ...
        this.GIFT_LOOTS.add(new ItemEntry("minecraft:golden_apple", "{display:{Name:'{\"text\":\"Fancier Apple\"}'}}"));
        this.GIFT_LOOTS.add(new ItemEntry("minecraft:iron_sword", "{Enchantments:[{id:\"minecraft:sharpness\",lvl:10s}]}"));
